...
# st.write("Machine Learning based Fake News Classifier")
...
#         st.error("❌ Fake.csv or True.csv is empty or corrupted")
#         st.stop()
...
#     # Some datasets use 'text', some use 'content'
...
# # -----------------------------
# st.markdown("---")
# st.caption("Fake News Detection | ML + NLP | Logistic Regression")
...
# # --------------------------------------------------
# st.markdown("---")
# st.caption("Fake News Detection | NLP + Machine Learning")
